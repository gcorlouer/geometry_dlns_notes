...
\[
(c_1,\ldots,c_{L}),\qquad c_i:=\ell(P_i),
\]
...
With $Q=C_{L+1}$ and $I=(p_1,\ldots,p_{L})$ as above, the algebra $A=kQ/I$ is a \emph{cyclic monomial Nakayama algebra}.
...
\begin{proof}
By construction, the ideal $I$ is generated by the paths $p_1,\ldots,p_{L}$, hence $I$ is monomial and $A$ is a monomial algebra.
...
Fix $Q=C_{L+1}$ with vertices $Q_0=\{0,\dots,L\}$ and arrows $a_i:i+1\to i$ for $i=0,\dots,L$ and $a_{L+1}:L\to 0$.
